...
const copy = {
  pt: {
    ...
    externalOnly: 'Este restaurante usa um menu externo. Abra-o abaixo.',
  ...
  es: {
    ...
    externalOnly: 'Este restaurante usa un menú externo. Ábrelo abajo.',
  ...
  en: {
    ...
    externalOnly: 'This restaurant uses an external menu. Open it below.',
  ...
  fr: {
    ...
    externalOnly: 'Ce restaurant utilise un menu externe. Ouvrez-le ci-dessous.',
