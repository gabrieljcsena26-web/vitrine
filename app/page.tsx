...
const homeCopy = {
  pt: {
    login: 'Entrar', getStarted: 'Começar', badge: '3 estruturas prontas para negócios locais',
    ...
    primaryCta: 'Criar minha Vitrine', secondaryCta: 'Entrar no dashboard', landingDemoCta: 'Ver planos', stats: [['3', 'Modelos'], ['1 clique', 'WhatsApp/Booking'], ['24/7', 'Online']],
    ...
    previewEyebrow: 'Estruturas por segmento', previewTitle: 'Modelos prontos para restauração, salão, clínicas e escritórios.', previewText: 'Cada estrutura muda para o objetivo certo: pedido, agendamento, consulta ou contacto profissional.',
    ...
    readyTags: ['Landing pronta', 'Leads por WhatsApp', 'Base de SEO'], readyTitle: 'Pronto para colocar no ar?', readyText: 'Crie uma página profissional e veja exatamente como seu negócio pode aparecer online.', readyCta: 'Criar minha página',
  ...
  en: {
    login: 'Login', getStarted: 'Get started', badge: 'Landing page + leads + dashboard',
    ...
    primaryCta: 'Create my page', secondaryCta: 'Open dashboard', landingDemoCta: 'View plans', stats: [['4', 'Languages'], ['2', 'Plans'], ['24/7', 'Online page']],
    ...
    valueEyebrow: 'Built for selling', valueTitle: 'A simple page to turn visitors into real contacts.', valueText: 'No complicated website: your business gets one focused page with WhatsApp, booking, photos, reviews, location and easy metrics.', demoCta: 'Get started',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.92fr] gap-10 items-center">
            <div className="max-w-3xl">
              ...
              <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4">
                ...
                <Link
                  href="/billing"
                  className="bg-white text-navy px-8 py-4 rounded-full font-bold text-lg hover:bg-stone-100 transition-all flex items-center gap-2 justify-center"
                >
                  {t.landingDemoCta}
