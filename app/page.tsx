...
const homeCopy = {
  pt: {
    ...
    primaryCta: 'Criar minha Vitrine', secondaryCta: 'Ver dashboard teste', landingDemoCta: 'Ver landing demo', stats: [['3', 'Modelos'], ['1 clique', 'WhatsApp/Booking'], ['24/7', 'Online']],
  ...
  en: {
    ...
    primaryCta: 'Create my page', secondaryCta: 'Open demo dashboard', landingDemoCta: 'View landing demo', stats: [['4', 'Languages'], ['2', 'Plans'], ['24/7', 'Online page']],
