...
const VIVID_PALETTES = [
  { id: 'champagne', label: 'Champagne', dot: '#B8902F', accent: '#B8902F', accentStrong: '#6E5212', accentSoft: 'rgba(184,144,47,0.16)', page: 'linear-gradient(180deg,#efe3c6 0%,#fbf5e6 48%,#e3cd9b 100%)', surface: 'linear-gradient(180deg,rgba(110,82,18,0.10),rgba(110,82,18,0.03))', card: '#fffdf6', line: 'rgba(110,82,18,0.22)' },
  { id: 'emerald', label: 'Esmeralda', dot: '#0E8A5F', accent: '#0E8A5F', accentStrong: '#06513A', accentSoft: 'rgba(14,138,95,0.16)', page: 'linear-gradient(180deg,#c8ecdd 0%,#ecfaf3 48%,#a3ddc7 100%)', surface: 'linear-gradient(180deg,rgba(6,81,58,0.10),rgba(6,81,58,0.03))', card: '#f7fffb', line: 'rgba(6,81,58,0.22)' },
  { id: 'royal', label: 'Azul Royal', dot: '#2148C0', accent: '#2148C0', accentStrong: '#122A78', accentSoft: 'rgba(33,72,192,0.16)', page: 'linear-gradient(180deg,#cdddff 0%,#ecf3ff 48%,#a8c6ff 100%)', surface: 'linear-gradient(180deg,rgba(18,42,120,0.10),rgba(18,42,120,0.03))', card: '#f6faff', line: 'rgba(18,42,120,0.22)' },
  { id: 'burgundy', label: 'Bordô', dot: '#9B1B3F', accent: '#9B1B3F', accentStrong: '#5E0F26', accentSoft: 'rgba(155,27,63,0.16)', page: 'linear-gradient(180deg,#f1cdd7 0%,#fbe9ee 48%,#e7a9ba 100%)', surface: 'linear-gradient(180deg,rgba(94,15,38,0.10),rgba(94,15,38,0.03))', card: '#fffafb', line: 'rgba(94,15,38,0.22)' },
  { id: 'plum', label: 'Ametista', dot: '#6D28D9', accent: '#6D28D9', accentStrong: '#431483', accentSoft: 'rgba(109,40,217,0.16)', page: 'linear-gradient(180deg,#ddd0f5 0%,#f0eaff 48%,#c6b0f0 100%)', surface: 'linear-gradient(180deg,rgba(67,20,131,0.10),rgba(67,20,131,0.03))', card: '#fbfaff', line: 'rgba(67,20,131,0.22)' },
  { id: 'teal', label: 'Petróleo', dot: '#0E7490', accent: '#0E7490', accentStrong: '#08475A', accentSoft: 'rgba(14,116,144,0.16)', page: 'linear-gradient(180deg,#c5e8f0 0%,#ebf8fb 48%,#9fd7e4 100%)', surface: 'linear-gradient(180deg,rgba(8,71,90,0.10),rgba(8,71,90,0.03))', card: '#f5fdff', line: 'rgba(8,71,90,0.22)' },
  { id: 'graphite', label: 'Grafite', dot: '#334155', accent: '#334155', accentStrong: '#0F172A', accentSoft: 'rgba(51,65,85,0.16)', page: 'linear-gradient(180deg,#d6dde6 0%,#f1f4f8 48%,#b7c2d0 100%)', surface: 'linear-gradient(180deg,rgba(15,23,42,0.10),rgba(15,23,42,0.03))', card: '#fbfcfe', line: 'rgba(15,23,42,0.20)' },
] as const
