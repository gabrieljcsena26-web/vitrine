...
const copy = {
  pt: {
    ...
    title: 'Esta página ainda está em modo demo.',
    ...
    watermark: 'DEMO VITRINE',
    ribbon: 'Preview não publicado',
  },
  en: {
    label: 'Vitrine Preview',
    title: 'This page is still in demo mode.',
    ...
    watermark: 'VITRINE DEMO',
    ribbon: 'Unpublished preview',
  },
  es: {
    label: 'Vista previa Vitrine',
    title: 'Esta página aún está en modo demo.',
  ...
  fr: {
    ...
    title: 'Cette page est encore en mode démo.',
