...
export const commercialDemos: CommercialDemo[] = [
  {
    slug: 'restauracao',
    variant: 'food',
    businessName: 'Casa Aurora Bistro',
    category: 'Restauração: restaurantes, bares e cafés',
    headline: 'Pratos desejáveis, ambiente elegante e reservas em poucos segundos.',
    subheadline: 'Uma demonstração premium para restaurantes: nome forte, fotos reais dos pratos, cardápio interativo, QR de mesa, localização e WhatsApp no momento certo.',
    ...
    theme: { badge: 'Restaurante premium + QR menu', primary: 'bg-orange-950', accent: 'text-orange-200' },
    photos: [
    ...
    services: [
      { name: 'Prato assinatura Aurora', price: '', description: 'Criação da casa com legumes da estação, proteína premium e finalização elegante.', photo: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=1200&auto=format&fit=crop' },
      { name: 'Tábua para partilhar', price: '', description: 'Entradas, queijos, azeite aromático e pequenos sabores para abrir a mesa.', photo: 'https://images.unsplash.com/photo-1543352634-a1c51d9f1fa7?q=80&w=1200&auto=format&fit=crop' },
      { name: 'Bowl mediterrâneo', price: '', description: 'Opção colorida, fresca e equilibrada para almoço ou jantar leve.', photo: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=80&w=1200&auto=format&fit=crop' },
      { name: 'Sobremesa de assinatura', price: '', description: 'Final doce, bonito e memorável para fechar a experiência.', photo: 'https://images.unsplash.com/photo-1551024601-bec78aea704b?q=80&w=1200&auto=format&fit=crop' },
    ],
